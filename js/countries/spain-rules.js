...
export const ROUTE_RULES = Object.freeze({
  ...
  ES_HIGHLY_QUALIFIED: { scenarios: ['SPANISH_JOB_OFFER'], separateBasis: 'Нужно предложение квалифицированной работы от работодателя в Испании.', missingSalaryThreshold: true },
  ES_STUDENT: { scenarios: ['STUDY'], separateBasis: 'Нужно основание для обучения и средства на проживание.' },
